...
import { FaEye, FaEyeSlash, FaEnvelope, FaLock, FaUser, FaSpinner, FaPhone } from 'react-icons/fa';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Join FinanceEase and take control of your finances
          </p>
        </div>
        ...
        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
          <p>© 2024 FinanceEase. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
